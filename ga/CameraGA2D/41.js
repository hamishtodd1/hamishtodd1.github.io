...
function createVerboseSharedFunctions(createFunction) {
    ...
    createFunction(`conjugate_41`,[`mv`],`
    target[ 0] =  mv[ 0];
    target[ 1] = -mv[ 1];
    target[ 2] = -mv[ 2];
    target[ 3] = -mv[ 3];
