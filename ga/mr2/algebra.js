...
{
    function replaceSignature(func,newSignature) {
    ...
    //mv
    {
        ...
        appendToGaShaderString(replaceSignature(gp,
        ...
        appendToGaShaderString(replaceSignature(join,
        ...
        appendToGaShaderString(replaceSignature(reverse,
        ...
        appendToGaShaderString(replaceSignature(inner,
...

    {
        ...
        {
            this.scalar = 0.
            this.euclideanLine = new Float32Array(3)
        ...
        locateUniformDualQuat = function(program,dqName)
        {
            ...
            program.locateUniform(dqName + "." + "euclideanLine")
        ...
        zeroDq = (dq) =>
        {
            ...
            dq.euclideanLine[ 0] = 0.; dq.euclideanLine[ 1] = 0.; dq.euclideanLine[ 2] = 0.;
            dq.pss = 0.;
        }
        appendToGaShaderString(replaceSignature(zeroDq,
        ...
        rotator = ( dq, angle, target) =>
        {
            target.scalar = Math.cos(angle / 2.);
            let sin = Math.sin(angle / 2.);
            target.euclideanLine[0] = sin * dq.euclideanLine[0];
            target.euclideanLine[1] = sin * dq.euclideanLine[1];
            target.euclideanLine[2] = sin * dq.euclideanLine[2];
            return target;
        }
        appendToGaShaderString(`
        dualQuat rotator(dualQuat dq,float angle) {
    ...
    gaShaderString += `
        ...
        void dualQuatToMv(dualQuat dq, inout float mv[16]) {
            zeroMv(mv);
            mv[ 0] = dq.scalar;
