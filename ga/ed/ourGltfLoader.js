function initGltf() {
    ...
    class GLTFLoader extends THREE.Loader {
        ...
        constructor(manager) {
            ...
            this.register(function (parser) { return new GLTFMaterialsEmissiveStrengthExtension(parser); });
            this.register(function (parser) { return new GLTFMaterialsSpecularExtension(parser); });
            this.register(function (parser) { return new GLTFMaterialsIridescenceExtension(parser); });
    ...
    class GLTFParser {
        ...
        constructor(json = {}, options = {}) {
            ...
            // log(json)
            //want textures, normals, vertices, uvs, bones, weights
            //THIS IS THE PLACE TO COME HAMISH
         ...
         * @param {string} type
         * @param {number} index
         * @return {Promise<THREE.Object3D|THREE.Material|THREE.THREE.Texture|THREE.AnimationClip|ArrayBuffer|Object>}
         */
         ...
         * @return {Promise<THREE.THREE.Texture>}
         */
        loadTexture(textureIndex) {
