...
meetDq(b, target) {
    ...
    target[6] = + b[6] * this[0] + b[0] * this[6];
...
innerDq(b, target) {
    ...
    target[1] = + b[1] * this[0] + b[0] * this[1] - b[7] * this[6] - b[6] * this[7];
    target[2] = + b[2] * this[0] + b[0] * this[2] - b[7] * this[5] - b[5] * this[7];
    target[3] = + b[3] * this[0] + b[0] * this[3] - b[7] * this[4] - b[4] * this[7];
    target[4] = + b[4] * this[0] + b[0] * this[4];
    target[5] = + b[5] * this[0] + b[0] * this[5];
    target[6] = + b[6] * this[0] + b[0] * this[6];

    target[7] = + b[7] * this[0] + b[0] * this[7];
...
mulFl(b, target) {
    ...
    target[1] = + b[1] * this[0] + b[2] * this[4] - b[3] * this[5] - b[7] * this[6];
    target[2] = + b[2] * this[0] - b[1] * this[4] - b[7] * this[5] + b[3] * this[6];
    target[3] = + b[3] * this[0] - b[7] * this[4] + b[1] * this[5] - b[2] * this[6];
    ...
    target[7] = + b[7] * this[0] + b[3] * this[4] + b[2] * this[5] + b[1] * this[6];
...
innerFl(b, target) {
    ...
    target[4] = + b[4] * this[0] - b[3] * this[7];
    target[5] = + b[5] * this[0] - b[2] * this[7];
    target[6] = + b[6] * this[0] - b[1] * this[7];
    target[7] = + b[7] * this[0];
