...
function initMouse() {
	...
	let focusPoint = new Mv().point(0.,1.6,0.,1.)
	function updateFromClientCoordinates(clientX, clientY) {
		...
		mv0.fromVec(raycaster.ray.origin)
		mv1.fromVec(raycaster.ray.direction)
		mv1[14] = 0.
		join(mv0,mv1,mouseRay)
		
		// let cameraPlane = camera.frustum.near.projectOn(focusPoint, mv3)
		// meet(cameraPlane,mouseRay,mv2)
		// mv2.toVec(mrh.position)

		//you want to implement, in cga, plane-meet-nO
	}
