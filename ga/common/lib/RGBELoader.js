...
const _floatViewForToHalfFloat = new Float32Array(1);
const _int32ViewForToHalfFloat = new Int32Array(_floatViewForToHalfFloat.buffer);
...
function toHalfFloat(val) {
    ...
    * by James Tursa?s half-precision code. */
    ...
    _floatViewForToHalfFloat[0] = val;
    const x = _int32ViewForToHalfFloat[0];
