function Download_initial_stuff(PreInitChecklist) {
	...
	OurLoadedThingsLinks[0] = "Data/vr_controller_vive_1_5.obj";
	OurLoadedThingsLinks[1] = "gentilis.js";
	OurLoadedThingsLinks[2] = "Data/Grain of sand.jpg";
	
	OurLoadedThingsLinks[3] = "Data/rubisco.obj";
//	OurLoadedThingsLinks[4] = "Data/rubisco2.obj";
//	OurLoadedThingsLinks[5] = "Data/rubisco3.obj";
//	OurLoadedThingsLinks[6] = "Data/rubisco4.obj";
//	OurLoadedThingsLinks[1] = testproteinlink;
	...
	for(var i = 0; i < OurLoadedThingsLinks.length; i++){
		...
		if(format === "obj")
			...
			Loaddae_initially(OurLoadedThingsLinks[i],i,OurLoadedThings, PreInitChecklist);
...
function Loaddae_initially(linkstring,ThisIndex,OurLoadedThings, PreInitChecklist)
{
	OurDAELoader.load(linkstring,
		function ( object ) {
			OurLoadedThings[ThisIndex] = object;
			PreInitChecklist.Downloads[ThisIndex] = 1;
			AttemptFinalInit(OurLoadedThings,PreInitChecklist);
		...
		function ( xhr ) {}, //progression function
		function ( xhr ) { console.error( "couldn't load DAE" ); }
	);
}
