...
//	ModelZero.add( Create_ribbon_representation_mesh( geometryAtoms ) );
	...
	ReturnedModel.radius = 30;
	var hitsphere = new THREE.Mesh(new THREE.SphereGeometry( ReturnedModel.radius, 32, 32 ), new THREE.MeshPhongMaterial( {color: 0xffff00, transparent: true, opacity: 0.4} ) );
//	ReturnedModel.add( hitsphere );
