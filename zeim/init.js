/*
	...
	If you're not running from a server (i.e. you're not intending to save things i.e. you're being run by a user), have some fun stuff come up in the console
*/
...
(function init()
{
	...
	var mouse = initMouse(renderer, [testObject]);
