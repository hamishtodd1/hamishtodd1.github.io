...
picture_properties[1] = {};	picture_properties[1].x = 0; 				picture_properties[1].y = vertical_separation; 	picture_properties[1].YtoX = 1;		picture_properties[1].name = "slides/caulio.png";
picture_properties[2] = {};	picture_properties[2].x = -one_third_out; 	picture_properties[2].y = vertical_separation; 	picture_properties[2].YtoX = 1;		picture_properties[2].name = "slides/cowpea.png";
picture_properties[3] = {};	picture_properties[3].x = -one_third_out; 	picture_properties[3].y =-vertical_separation; 	picture_properties[3].YtoX = 1;		picture_properties[3].name = "slides/herpes.png";
picture_properties[4] = {};	picture_properties[4].x = 0; 				picture_properties[4].y =-vertical_separation; 	picture_properties[4].YtoX = 1;		picture_properties[4].name = "slides/phyco.png";
picture_properties[5] = {};	picture_properties[5].x = one_third_out; 	picture_properties[5].y =-vertical_separation; 	picture_properties[5].YtoX = 1;		picture_properties[5].name = "slides/mimi.png";
picture_properties[6] = {};	picture_properties[6].x = 0; 				picture_properties[6].y = vertical_separation; 	picture_properties[6].YtoX = 1;		picture_properties[6].name = "slides/caulio spots.png";
picture_properties[7] = {};	picture_properties[7].x = -one_third_out; 	picture_properties[7].y = vertical_separation; 	picture_properties[7].YtoX = 1;		picture_properties[7].name = "slides/cowpea spots.png";
picture_properties[8] = {};	picture_properties[8].x = -one_third_out; 	picture_properties[8].y =-vertical_separation; 	picture_properties[8].YtoX = 1;		picture_properties[8].name = "slides/herpes spots.png";
picture_properties[9] = {};	picture_properties[9].x = 0; 				picture_properties[9].y =-vertical_separation; 	picture_properties[9].YtoX = 1;		picture_properties[9].name = "slides/phyco spots.png";
picture_properties[10] = {};picture_properties[10].x = -one_third_out;	picture_properties[10].y = vertical_separation;	picture_properties[10].YtoX = 1;		picture_properties[10].name = "slides/rhino.png";
picture_properties[11] = {};picture_properties[11].x = -one_third_out;	picture_properties[11].y =-vertical_separation; picture_properties[11].YtoX = 1;		picture_properties[11].name = "slides/largevirus.png";

picture_properties[12] = {};picture_properties[12].x = OQO *-1.5;		picture_properties[12].y = 0; 					picture_properties[12].YtoX = 2;		picture_properties[12].name = "slides/T4.png";
picture_properties[13] = {};picture_properties[13].x = OQO *-0.5;		picture_properties[13].y = 0; 					picture_properties[13].YtoX = 2;		picture_properties[13].name = "slides/long virus.png";
picture_properties[14] = {};picture_properties[14].x = OQO * 0.5;		picture_properties[14].y = 0; 					picture_properties[14].YtoX = 2;		picture_properties[14].name = "slides/HIV EM.png";
picture_properties[15] = {};picture_properties[15].x = OQO * 1.5;		picture_properties[15].y = 0; 					picture_properties[15].YtoX = 2;		picture_properties[15].name = "slides/HIV model.png";
picture_properties[16] = {};picture_properties[16].x = -one_third_out;	picture_properties[16].y = 0; 					picture_properties[16].YtoX = 1;		picture_properties[16].name = "slides/cube net.png";
picture_properties[17] = {};picture_properties[17].x = -one_third_out;	picture_properties[17].y = 0;					picture_properties[17].YtoX = 2;		picture_properties[17].name = "slides/angular defect proteins.png";

picture_properties[18] = {};picture_properties[18].x = one_third_out;	picture_properties[18].y = vertical_separation; picture_properties[18].YtoX = 0.25;	picture_properties[18].name = "slides/the rule.png";
picture_properties[19] = {};picture_properties[19].x = one_third_out;	picture_properties[19].y =-vertical_separation; picture_properties[19].YtoX = 0.5;	picture_properties[19].name = "slides/HPV EM.png";
picture_properties[20] = {};picture_properties[20].x = OQO *-1.5;		picture_properties[20].y = vertical_separation; picture_properties[20].YtoX = 1;		picture_properties[20].name = "slides/STMV nice.jpg";
picture_properties[21] = {};picture_properties[21].x = OQO *-0.5;		picture_properties[21].y = vertical_separation; picture_properties[21].YtoX = 1;		picture_properties[21].name = "slides/LA model.png";
picture_properties[22] = {};picture_properties[22].x = OQO *-1.5;		picture_properties[22].y =-vertical_separation; picture_properties[22].YtoX = 1;		picture_properties[22].name = "slides/dengue model.png";
picture_properties[23] = {};picture_properties[23].x = OQO *-0.5;		picture_properties[23].y =-vertical_separation; picture_properties[23].YtoX = 1;		picture_properties[23].name = "slides/HPV model.png";

picture_properties[24] = {};picture_properties[24].x = OQO *-1.5;		picture_properties[24].y = 0;					picture_properties[24].YtoX = 2;		picture_properties[24].name = "slides/Reidun.png";
picture_properties[25] = {};picture_properties[25].x = OQO *-0.5;		picture_properties[25].y =-vertical_separation; picture_properties[25].YtoX = 1;		picture_properties[25].name = "slides/LA lines.png";

picture_properties[26] = {};picture_properties[26].x = -one_third_out;	picture_properties[26].y = 0; 					picture_properties[26].YtoX = 1;		picture_properties[26].name = "slides/diffraction.png";
picture_properties[27] = {};picture_properties[27].x = 0; 				picture_properties[27].y = 0; 					picture_properties[27].YtoX = 2;		picture_properties[27].name = "slides/more crystals.png";
picture_properties[28] = {};picture_properties[28].x = one_third_out;	picture_properties[28].y = 0; 					picture_properties[28].YtoX = 1;		picture_properties[28].name = "slides/crystal.png";
picture_properties[29] = {};picture_properties[29].x = -one_third_out;	picture_properties[29].y = 0; 					picture_properties[29].YtoX = 1;		picture_properties[29].name = "slides/pariacoto.png";

picture_properties[30] = {};picture_properties[30].x = -5.8; 			picture_properties[30].y = 2.8;					picture_properties[30].YtoX = 0.5;	picture_properties[30].name = "slides/logo.png";
picture_properties[31] = {};picture_properties[31].x = 0; 				picture_properties[31].y = 0;					picture_properties[31].YtoX = 0.5;	picture_properties[31].name = "slides/Opening slide.png";
