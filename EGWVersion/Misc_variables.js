...
var camera = new THREE.CombinedCamera( playing_field_dimension * 2, playing_field_dimension, vertical_fov * 360 / TAU, 0.1, 1000, 0.1, 1000);
var scene = new THREE.Scene();

var window_height = 540;
var window_width = window_height*2;
