...
//					var lowest_used_vertex = quasicutouts[i].geometry.attributes.position.array.length / 3 - NUM_QS_VERTICES_FOR_EDGES + 6 * k;
//					quasicutout_meshes[i][j].geometry.faces.push( new THREE.Face3(
//							lowest_used_vertex + prism_triangle_indices[m*3+0], lowest_used_vertex + prism_triangle_indices[m*3+1], lowest_used_vertex + prism_triangle_indices[m*3+2],
